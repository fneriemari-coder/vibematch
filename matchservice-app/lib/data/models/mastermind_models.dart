...
class MastermindSession {
  ...
  factory MastermindSession.fromJson(Map<String, dynamic> json) =>
      MastermindSession(
        ...
        hostName: (json['host'] as Map<String, dynamic>?)?['profile']?['name']
            ...
            'Host',
        bookingsCount:
            (json['_count'] as Map<String, dynamic>?)?['bookings'] as int? ?? 0,
        hasLiveStreamUrl: json['liveStreamUrl'] != null,
      );
}

class MastermindAccess {
  const MastermindAccess({
    required this.title,
    required this.scheduledFor,
  ...
  factory MastermindAccess.fromJson(Map<String, dynamic> json) =>
      MastermindAccess(
        title: json['title'] as String? ?? '',
        scheduledFor: DateTime.parse(json['scheduledFor'] as String),
