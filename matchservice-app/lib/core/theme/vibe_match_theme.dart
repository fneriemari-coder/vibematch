...
class VibeMatchColors {
  ...
  static const Color surface = Color(0xFF2A1B3D); // Dark Glass (use withOpacity(0.8) on cards)
  static const Color neonPrimary = Color(0xFF00F0FF); // Neon Cyan accent
  static const Color scoreGold = Color(0xFFFFB800); // Sculpted Gold — ratings/K-Score
  ...
  static const List<Color> ctaGradient = [background, neonPrimary]; // Amethyst -> Cyan
}
  ...
  return base.copyWith(
    ...
    elevatedButtonTheme: ElevatedButtonThemeData(
      style: ElevatedButton.styleFrom(
        ...
        shape: RoundedRectangleBorder(borderRadius: VibeMatchRadii.buttonRadius),
